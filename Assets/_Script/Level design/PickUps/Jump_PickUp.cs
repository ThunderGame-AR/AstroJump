...
public class Jump_PickUp : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            _manager.ActivateJump(durationInSeconds, redThresholdInSeconds, jumpMultiplier, keepPickUpsEffectsOnRespawn);
